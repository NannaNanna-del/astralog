...
public:
  ...
  static std::shared_ptr<Rule> from_json(const json &json, std::vector<std::shared_ptr<Rule>> &rules);
...
class SimpleRule : public Rule {
 private:
  ...
  public:
  SimpleRule(const std::string &id, double threshold, std::optional<Priority> priority, const std::string &sensor_id, char op);
...
class StepDifferenceRule : public Rule {
  ...
  public:
  StepDifferenceRule(const std::string &id, double threshold, std::optional<Priority> priority, const std::string &sensor_id, char op);
    std::string id() const override;
    RuleType type() const override;
    std::optional<Priority> priority() const override;
    std::string sensor_id() const override;
...
class StatefulRule : public Rule {
  ...
  public:
  StatefulRule(const std::string &id, double threshold, std::optional<Priority> priority,
...
class CorrelationRule : public Rule {
  ...
  public:
  CorrelationRule(const std::string &id, std::optional<Priority> priority, const std::string &logic, 
